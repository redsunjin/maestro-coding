          ...
          {shouldCollapsePanelControls && (
            <div ref={panelMenuRef} className="relative shrink-0">
              <button
                ...
                className="rounded-full border border-gray-700 bg-gray-900/80 px-3 py-1.5 text-[11px] font-semibold text-gray-200 transition-colors hover:border-cyan-400/50 hover:text-cyan-100"
              >
                Panels
              </button>
              {isPanelMenuOpen && (
