...
test('player harness keeps required docs and source files in sync', () => {
  const requiredPaths = [
    ...
    '../tests/adrenalineEffectCatalog.test.mjs',
    '../tests/musicValidationHarness.test.mjs',
    '../tests/goldenListeningSet.test.mjs',
    '../tests/fixtures/goldenListeningSet.mjs',
